...
sudo pacman -S niri nautilus fuzzel mako waybar xdg-desktop-portal-gnome swaybg kitty polkit-gnome vesktop steam heroic-games-launcher-bin helium-browser-bin proton-cachyos tela-circle-icon-theme-green
